...
function Nav() {
  ...
  return (
    <nav
      className={`hidden sticky top-0 px-5 h-[20vh] lg:flex items-center ${
        isDark ? "bg-black" : "bg-white"
      } transition-all duration-[750ms] ease-out z-50`}
    >
      <ul className="flex items-center justify-end md:text-3xl gap-x-5 font-medium w-full">
        ...
        <li className="px-5 py-2 rounded-3xl text-white bg-green-700">

...
import { login, logout, profile, register, validateToken , updateData, deleteUser, updateEmail, getEmail, sendAiTokens, updateAiTokens, deleteOpenAiToken} from "../controllers/auth.controller.js";
...
router.delete('/profile/tokens/openai', authRequired , deleteOpenAiToken);
